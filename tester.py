...
if __name__ == '__main__':
    ...
    for run in range(2):
        ...
        while run_active:
            ...
            print 'next move = ' + str(rotation) + ', ' + str(movement)
            ...
            #print goal_bounds
            #print '[0]' + str(robot_pos['location'][0])
            #print '[1]' + str(robot_pos['location'][1])
            #print robot_pos['location'][0] in goal_bounds
            #print robot_pos['location'][1] in goal_bounds
